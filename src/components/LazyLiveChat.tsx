...
export default function LazyLiveChat() {
  ...
  return (
    <button
      ...
      className="hidden md:flex fixed bottom-6 left-6 w-14 h-14 bg-black text-white rounded-full shadow-lg hover:bg-gray-800 transition-colors items-center justify-center z-50"
