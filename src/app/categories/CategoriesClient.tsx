      ...
      <div className="page-container pt-4 md:pt-6 pb-8 md:pb-12">
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-32 bg-gradient-to-br from-gray-50 to-white rounded-2xl border-2 border-gray-200">
            ...
            <h3 className="text-2xl font-heading font-bold text-gray-900 mb-3">{t('categories.no_categories_found')}</h3>
          ...
          >
            {filteredCategories.map((category, index) => (
              ...
              >
                <div className="bg-white border-2 border-gray-200 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl hover:border-gray-300 transition-all duration-300 hover:-translate-y-2">
            ...
            {filteredCategories.map((category) => (
              ...
              >
                <div className="flex gap-6 bg-white border-2 border-gray-200 rounded-2xl p-6 hover:border-gray-300 hover:shadow-xl transition-all duration-300">
                  <div className="relative w-32 h-32 md:w-40 md:h-40 flex-shrink-0 rounded-xl overflow-hidden bg-gray-50">
                    {category.imageUrl ? (
                      <Image
                        src={category.imageUrl}
                        alt={getCategoryName(category as unknown as import('@/lib/firestore/categories').Category, languageCode)}
