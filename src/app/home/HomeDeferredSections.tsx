...
export default function HomeDeferredSections({ showHero = false }: { showHero?: boolean }) {
    ...
    const fetchData = async () => {
      try {
        const [
          ...
          showHero ? getAllBanners() : Promise.resolve([]),
          getAllProducts(),
          getAllCategories(),
  ...
  return (
    <div className="flex flex-col">
      ...
      {showHero && isHomepageSectionEnabled('hero') && (
      <section 
